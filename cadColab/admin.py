...
class ColaboradoresAdmin(admin.ModelAdmin):
    ...
    readonly_fields = ()
    fields = ["nome", "status", "vinculo", ("matricula", "posseFioce", "cargo"), ("empresa"), ("bolsa", "vigenc_bolsa"), "area", "ingresso", "coord_resp", "email_pess", "adic_ocup", "ramal", "cracha", "amb_sala", ("vacinado", "card_vac"), "genero", "cpf", "nascimento", "rg_ident", "orgao_ident", "tel_res", "celular", ("formacao", "nivel_form"), ("estado", "municipio", "cep_end", "bairro", "logradouro", "num_end", "comp_end"), "plano_sau", "fator_rh", "banco", ("model_veic", "cor_veic", "placa_veic"), "foto_pess", "obs",]
